"""Embed generated CGST Rules chunks with BAAI/bge-m3 for inspection."""
...
DEFAULT_RULE_EMBEDDINGS_JSONL = Path("data/rules/gst_rules_bge_m3_embeddings.jsonl")


def main():
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("chunks_json", nargs="?", default=DEFAULT_RULE_CHUNKS_JSON)
    parser.add_argument("--output", type=Path, default=DEFAULT_RULE_EMBEDDINGS_JSONL)
